...
public class HttpSubTaskServerTest {
    ...
    private final Gson gson = SubTasksHandler.getGson();
    ...
    public void testAddTasks() throws Exception {
        ...
        List<SubTask> tasksFromManager = inMemoryTaskManager.getAllTasksOfSubTask();
        ...
        assertEquals("TestTask_1", tasksFromManager.getFirst().getTaskName(),
                "Имена задач не совпали");
    }
    ...
    public void testUpdateEpic() throws IOException, InterruptedException {
        ...
        SubTask createdTask1 = gson.fromJson(response.body(), SubTask.class);
        SubTask createdTask2 = gson.fromJson(response2.body(), SubTask.class);

        URI urlTasks_1_WithId = URI.create("http://localHost:8080/api/subtasks/" + createdTask1.getID());
        URI urlTasks_2_WithId = URI.create("http://localHost:8080/api/subtasks/" + createdTask2.getID());
    ...
    public void testGetTaskFromId() throws IOException, InterruptedException {
        ...
        SubTask taskFromServer_1 = gson.fromJson(responseGetTask_1.body(), SubTask.class);
        ...
        SubTask taskFromServer_2 = gson.fromJson(responseGetTask_2.body(), SubTask.class);
    ...
    public void testNotAcceptable() throws IOException, InterruptedException {
        ...
        SubTask taskTest_1 = new SubTask("TestTask_1", "Test", Task.Status.NEW, 0,
                LocalDateTime.now(), Duration.ofMinutes(30));
        SubTask taskTest_2 = new SubTask("TestTask_2", "Test", Task.Status.NEW, 0,
                LocalDateTime.now(), Duration.ofMinutes(30));
    ...
    public void testNotFound() throws IOException, InterruptedException {
        HttpClient httpClient = HttpClient.newHttpClient();
        URI urlTasks_1_WithId = URI.create("http://localHost:8080/api/subtasks/" + 0);
