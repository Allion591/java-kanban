...
public class PrioritizedHandler extends BaseHttpHandler implements HttpHandler {
    ...
    PrioritizedHandler(InMemoryTaskManager inMemoryTaskManager) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        try {
            ...
            if (requestMethod.equals("GET")) {
                if (Pattern.matches("^/api/prioritized$", path)) {
                    String response = gson.toJson(inMemoryTaskManager.getPrioritizedTasks());
